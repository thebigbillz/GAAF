(function ($) {
  ...
  function headerStyle() {
    if ($(".main-header").length) {
      ...
      var sticky_header = $(
        ".main-header .sticky-header, .header-style-three, .header-style-four"
      );
      if (windowpos > 100) {
  ...
  function contactForm() {
    if ($(".contactForm").length) {
      ...
      let submitTitle = document.querySelector(".submit-titles");
      ...
      contactForm.addEventListener("submit", (e) => {
        ...
        xhr.open("POST", "https://gaaf-mailer.herokuapp.com/api/email");
        ...
        xhr.onload = function () {
          ...
          if (JSON.parse(xhr.responseText).message == "success") {
            ...
            phone.value = "";
            content.value = "";
            submitTitle.innerText = "Sent ✓";
            setTimeout(function () {
              submitTitle.innerText = "Submit";
            }, 2000);
          } else {
            submitTitle.innerText = "Sending Failed";
            setTimeout(function () {
              submitTitle.innerText = "Submit";
            }, 2000);
          }
